...
void inicializarTela() {
  tft.begin();
  tft.setRotation(1); 
  tft.fillScreen(ILI9341_WHITE); // Mantém o fundo branco padrão do projeto
}
...
// --- NOVO RELÓGIO DIGITAL ---
void desenharRelogioDigital(int h, int m, int s) {
  // Escrita em preto com fundo branco para evitar o efeito de piscar (flicker)
  tft.setTextColor(ILI9341_BLACK, ILI9341_WHITE); 
  tft.setTextSize(6); 
  
  // Posicionamento centralizado na tela de 320x240
